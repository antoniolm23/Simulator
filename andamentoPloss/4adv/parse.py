...
with open("../4channel/4adv/sim.txt") as sim3:
	for linef in sim3:
		str1 = linef.split('\t')
		if str1[0] == 'ploss01':
...
with open("../8channel/4adv/sim.txt") as sim3:
	for linef in sim3:
		str1 = linef.split('\t')
		if str1[0] == 'ploss01':
...
with open("../16channels/4adv/sim.txt") as sim3:
	for linef in sim3:
		str1 = linef.split('\t')
		if str1[0] == 'ploss01':
...
with open("../4channel/4adv/formula.txt") as form:
	for linef in form:
		str1 = linef.split('\t')
		if str1[0] == 'Fploss0.1:':
...
with open("../8channel/4adv/formula.txt") as form:
	for linef in form:
		str1 = linef.split('\t')
		if str1[0] == 'Fploss0.1:':
...
with open("../16channels/4adv/formula.txt") as form:
	for linef in form:
		str1 = linef.split('\t')
		if str1[0] == 'Fploss0.1:':
